...
function ProfessorNotificationsPage() {
  ...
  if (loading) {
    return (
      <div className="page-shell professor-notifications-page">
  ...
  return (
    <div className="page-shell professor-notifications-page">
      <header className="professor-notifications-page__header">
        <div>
          <h1 className="section-title">Notificaciones</h1>
          <p className="section-subtitle">
            Acá vas a ver el historial de avisos importantes para tu cuenta.
          </p>
        </div>

        <div className="professor-notifications-page__actions">
          <Button
            type="button"
            variant="secondary"
      ...
      {notifications.length ? (
        <div className="professor-notifications-page__list">
          {notifications.map((notification) => (
            ...
            >
              <div className="professor-notifications-page__card-top">
                ...
                {!notification.isRead ? (
                  <span className="professor-notifications-page__unread-dot" />
                ) : null}
              </div>

              <p className="professor-notifications-page__message">
              ...
              <div className="professor-notifications-page__footer">
                ...
                {!notification.isRead ? (
                  ...
                  <span className="professor-notifications-page__read-label">
                    Leída
                  </span>
                )}
              </div>
